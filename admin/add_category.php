                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="cat_name" placeholder="Category Name" name="cat_name">
                    </div>
                  </div>
                  <!-- /.box-body -->
                  ...
                  <div class="box-footer">
                      ...
                      <input type="submit" class="btn btn-success" value="Add Category" name="add_cat">
                    </div>
                </form>
            </div>
        </div>
