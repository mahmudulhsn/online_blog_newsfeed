                ...
                <div class="box box-primary">
                        ...
                        <?php 
                          if (isset($_POST['pub_post'])) {
                            ...
                            $cat_id        = $_POST['cat_id'];
                            $author_id     = fetchAuthorID(get_username('username'));
                            ...
                            if (empty($post_title) || empty($post_content) || empty($post_thumb) || empty($cat_id) ) {
                                echo "<h2 class='text btn-danger'>Error!! Field must not be empty.</h2>";
                              }
                              else{
                                if (addNewPost($post_title, $post_content, $dir, $post_tags, $cat_id, $author_id)) {

                                      move_uploaded_file($temp, "uploads/".$post_thumb);
                                   echo "<h2 class='text btn-success'>Post Added successfully.</h2>";
                                    }else{
                        ...
                        <form action="" role="" method="POST" enctype="multipart/form-data">
                            <div class="box-body">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="post_tags" placeholder="Tags separated with commas..." name="post_tags">
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <textarea id="editor1" rows="10" cols="80" name="post_content"></textarea>
                                  </div>
                            </div>
                            <!-- /.box-body -->
                          ...
                          <?php
                                ...
                                echo "<a href='add_category.php' class='btn btn-primary'>Add Category First</a>";
                            }
                            ?>
